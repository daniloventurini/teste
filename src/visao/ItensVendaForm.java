 ...
 * @author pos
 */
public class ItensVendaForm extends javax.swing.JDialog {
    ...
    /** Creates new form ItensVendaForm */
    public ItensVendaForm(java.awt.Frame parent, boolean modal, Venda venda) {
        super(parent, modal);
        initComponents();
    ...
    public void montaTabela() {
        ...
        for (Iterator<ItensVenda> it = objVenda.getItensVenda().iterator(); it.hasNext();) {
            ItensVenda itensVenda = it.next();
            modelo.addRow(new Object[]{itensVenda.getProduto().getNomeProduto(),
                        itensVenda.getQnt(), nf.format(itensVenda.getValor()), nf.format(itensVenda.getTotal())});
        }
    ...
    private void bRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemoverActionPerformed
        ...
        if (i == JOptionPane.YES_OPTION) {
            setObjeto(objVenda.getItensVenda().get(tabela.getSelectedRow()));
            objVenda.getItensVenda().remove(objeto);
